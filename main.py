    ...
    def recommendation_tags(new_df, selected_movie_name, pickle_file_path,description):
        ...
        with col2:
            ...
            st.markdown(
                f"""
                    <div class="poster-container">
                    <a href="https://www.youtube.com/results?search_query={rec_movies[1]}+trailer" 
                    target="_blank" class="poster-link">
                    <img src="{rec_posters[1]}" class="movie-poster" alt="{rec_movies[1]}">
                    <button class="trailer-button">
                            🎬 Watch Trailer
                        </button>
                    </a>
        ...
        with col3:
            ...
            st.markdown(
                f"""
                    <div class="poster-container">
                    <a href="https://www.youtube.com/results?search_query={rec_movies[2]}+trailer" 
                    target="_blank" class="poster-link">
                    <img src="{rec_posters[2]}" class="movie-poster" alt="{rec_movies[2]}">
                    <button class="trailer-button">
                            🎬 Watch Trailer
                        </button>
                    </a>
        ...
        with col4:
            poster_url = preprocess.fetch_posters(rec_movies[3])
            st.text(rec_movies[3])
            # Wrap the image in a div with the 'poster-container' class for hover effect
            st.markdown(
                f"""
                    <div class="poster-container">
                    <a href="https://www.youtube.com/results?search_query={rec_movies[3]}+trailer" 
                    target="_blank" class="poster-link">
                    <img src="{rec_posters[3]}" class="movie-poster" alt="{rec_movies[3]}">
                    <button class="trailer-button">
                            🎬 Watch Trailer
                        </button>
                    </a>
        ...
        with col5:
            poster_url = preprocess.fetch_posters(rec_movies[4])
            st.text(rec_movies[4])
            # Wrap the image in a div with the 'poster-container' class for hover effect
            st.markdown(
                f"""
                    <div class="poster-container">
                    <a href="https://www.youtube.com/results?search_query={rec_movies[4]}+trailer" 
                    target="_blank" class="poster-link">
                    <img src="{rec_posters[4]}" class="movie-poster" alt="{rec_movies[4]}">
                    <button class="trailer-button">
                            🎬 Watch Trailer
                        </button>
                    </a>
